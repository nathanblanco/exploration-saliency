...
# f = open("modeling results/aics_bland.txt", "w+")
# 
...
for cond in conds:
	...
	f = open("modeling results/RL_aics_"+cond+"_adults.txt", "w+")
	#f = open("modeling results/RL_aics_congruent_adults.txt", "w+")
	#f = open("modeling results/RL_aics_baseline_adults.txt", "w+")

	#f.write('subj eb_aic eb_Bev eb_Blag ebm_aic ebm_Bev ebm_weight\n')
	f.write('subj RL_aic\n')
	...
	#beh_data = openfile('congruent_adults.txt', n_trials)
	#beh_data = openfile('baseline_adults.txt', n_trials)
