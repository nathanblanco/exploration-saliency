...
plot(bl_line10_means/20, type='l', lty=2, col = 'blue', 
	 ...
	 xlab="Block (20 trials)", main='Baseline', cex.lab= 1.4, cex.axis=1.3, lwd=2, cex.main=1.7)
...
plot(comp_line10_means/20, type='l', lty=2, col = 'blue', 
	 ylim=c(0,1), ylab='Proportion of selections', 
	 xlab="Block (20 trials)", main='Competition', cex.lab= 1.4, cex.axis=1.3, lwd=2, cex.main=1.7)
...
plot(cong_line10_means/20, type='l', lty= 2, col = 'blue', 
	 ylim=c(0,1), ylab='Proportion of selections', 
	 xlab="Block (20 trials)", main='Congruent', cex.lab= 1.4, cex.axis=1.3, lwd=2, cex.main=1.7)
