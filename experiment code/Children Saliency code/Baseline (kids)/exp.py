...
#
experimentname = 'Exploration-Longitudinal'
paid = True
...
#         shuffle(self.creatures)
        ...
        #self.button_creatures = ['BL_creature1.png', 'BL_creature2.png', 'BL_creature3.png', 'BL_creature4.png']
        
        all_creatures = ['creature1.png', 'creature2.png', 'creature4.png', 'creature5.png', 'creature6.png',
        				 'creature7.png', 'creature8.png', 'creature9.png', 'creature10.png', 'creature11.png',
        				 'creature12.png', 'creature14.png', 'creature15.png', 'creature16.png', 'creature17.png',
        				 'creature18.png', 'creature20.png', 'creature22.png', 'creature24.png', 'creature25.png',
        				 ...
        				 'creature41.png', 'creature42.png', 'creature44.png', 'creature45.png', 'creature46.png',
        				 'creature47.png', 'creature48.png', 'creature49.png', 'creature50.png', 'creature51.png',
        				 'creature52.png', 'creature53.png']
        				 
        
        shuffle(all_creatures)
        
        self.button_creatures = all_creatures[:4]
    ...
    def final_screen(self):
        ...
        end_text = "Wow! You collected %s candies! That's a lot! You've won %s stickers!" % (self.earnings, self.goal_reached+1)
        self.place_text_image(background, end_text, 32, 0, -100, black, white)
        
        end_text2= "Thanks for playing! (press 'shift + ~' to close the experiment)"
    ...
    def draw_buttons(self, mysurf):
        ...
        self.buttons = []
        self.buttons = self.buttons + [RespButton(self.locations[0][0], self.locations[0][1], 360, 250, 0, self.resources[self.button_creatures[0]], self.resources[str(self.rewards[0])+'candy'+candy_type+'.png'],self.resources["recvdata.wav"], 3000, self)]
        self.buttons = self.buttons + [RespButton(self.locations[1][0], self.locations[1][1], 360, 250, 1, self.resources[self.button_creatures[1]], self.resources[str(self.rewards[1])+'candy'+candy_type+'.png'],self.resources["recvdata.wav"], 3000, self)]
        self.buttons = self.buttons + [RespButton(self.locations[2][0], self.locations[2][1], 360, 250, 2, self.resources[self.button_creatures[2]], self.resources[str(self.rewards[2])+'candy'+candy_type+'.png'],self.resources["recvdata.wav"], 3000, self)]
        self.buttons = self.buttons + [RespButton(self.locations[3][0], self.locations[3][1], 360, 250, 3, self.resources[self.button_creatures[3]], self.resources[str(self.rewards[3])+'candy'+candy_type+'.png'],self.resources["recvdata.wav"], 3000, self)]
    ...
    def do_regular_exp(self):
        ...
        self.show_instructions('instructions.png', 'begin.gif', None)
        ...
        self.show_instructions('instructions-test.png', 'next.gif', None)
